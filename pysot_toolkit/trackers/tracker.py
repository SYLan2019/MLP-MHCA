...
class Tracker(object):
    ...
    def __init__(self, name, net, window_penalty=0, window_influence=0, scale_lr=0, exemplar_size=128, instance_size=256):
        self.name = name
        self.net = net
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        penalty = np.exp(-(r_c * s_c - 1) * self.window_penalty)
        ...
        bbox = bbox * s_x
        lr = penalty[best_idx] * score[best_idx] * self.scale_lr
